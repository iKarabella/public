...
class SafeMySQL
{
	 ...
	 * Вспомогательная функция для получения одной строки прямо из запроса и необязательных аргументов
	 * Examples:
	 ...
	 * Вспомогательная функция для получения одного столбца прямо из запроса и необязательных аргументов
	 * Examples:
